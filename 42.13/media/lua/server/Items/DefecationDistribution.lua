...
table.insert(ProceduralDistributions.list.MedicalClinicDrugs.items, "Defecation.AntiDiarrhealPill")
table.insert(ProceduralDistributions.list.MedicalClinicDrugs.items, 2)
...
table.insert(ProceduralDistributions.list.MedicalStorageDrugs.items, "Defecation.AntiDiarrhealPill")
table.insert(ProceduralDistributions.list.MedicalStorageDrugs.items, 2)